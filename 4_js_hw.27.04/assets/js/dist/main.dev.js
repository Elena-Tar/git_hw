...
function createNumber() {
  //  debugger;
  var num1 = parseInt(document.getElementById("convert_number1").value);
  var num2 = parseInt(document.getElementById("convert_number2").value);
  var num3 = parseInt(document.getElementById("convert_number3").value);
  var rez = document.getElementById("convert_rez").innerHTML = create(num1, num2, num3);
}
/*Написать функцию, которая принимает длину и ширину прямоугольника и вычисляет его площадь.
 Если в функцию передали 1 параметр, то она вычисляет площадь квадрата.*/


function get_areaRectangle(a) {
...
function perfect_number_check(n) {
...
function perfect_number() {
  // debugger;
  var rez;
  var num1 = parseInt(document.getElementById("perfect_number1").value);
...
function range_number() {
  // debugger;
  var num1 = parseInt(document.getElementById("range_number1").value);
  var num2 = parseInt(document.getElementById("range_number2").value);
  var rez = "";
...
function time_sec_converter_number() {
  // debugger;
  var h_num = parseInt(document.getElementById("h_time").value);
...
function date() {
  debugger;
  var num1 = document.getElementById("date_number1").value;
  var num2 = document.getElementById("date_number2").value;
  var num1_arr = num1.split(':');
  var num2_arr = num2.split(':');
  var rez1_sec = time_covertor(parseInt(num1_arr[0]), parseInt(num1_arr[1]), parseInt(num1_arr[2]));
  var rez2_sec = time_covertor(parseInt(num2_arr[0]), parseInt(num2_arr[1]), parseInt(num2_arr[2]));
  var rez = getTime(_module(rez1_sec - rez2_sec));
